...
#foxactivity <- activityDensity(recordTable = recordTablePozo,
#                              species = Island Fox,
#                              allSpecies = FALSE, 
#                              speciesCol = "speciestag",
#                              )
...
#Error: record date outside camera operation date range:  SC04012, SC04006, SC0400M. I think this is because the date is in different formats in the various locations. Fixing this in the excel sheet. Hmmm. Fixed in in excel, still no good...
...
-find a way to inclue total days cam running- this is taken care of in my operations table
