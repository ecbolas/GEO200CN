...
One of the assumptions of linear regression is that the response variable has an approximately normal distribution where the mean, mode and median are equal, and where the curve is symmetrical around these measurements of central tendency.  
